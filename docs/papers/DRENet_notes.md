...
## 2026-09-20 1000 epochs 完成

| 指标 | 500 ep | 1000 ep | 论文 |
|---|---|---|---|
| mAP@0.5 | 76.3 | 78.4 | 82.4 |
| mAP@0.5:0.95 | 29.4 | 29.3 | — |
| Precision | 45.7 | 41.6 | — |
| Recall | 83.8 | 85.4 | — |
| box_loss | 0.0448 | 0.0404 | — |

### 与论文对比
- 差距从 6.1 缩小到 4.0
- 差异原因：batch 4 vs 16、RTX 4000 Ada vs V100

### 曲线分析
- box_loss、obj_loss 收敛良好
- mAP 稳定上升到 0.78
- val box loss 上升，轻微过拟合
- Recall 后期下降，模型偏向保守
